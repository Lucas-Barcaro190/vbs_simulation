...
def simulate_buoyancy_system(depth_command, dt=0.1, step_size=0.00005):
    """
...
def visualize_pid_dsm_system(t, depth_command, depth_actual, pid_output, actual_piston_height, motor_pulses):
    ...
    ax1.plot(t, depth_command, 'w--', label='Depth Command', linewidth=2)
    ...
    ax3.plot(t, actual_piston_height * 1000, 'w-', linewidth=1.5, label='Actual Piston Position (Quantized)')
