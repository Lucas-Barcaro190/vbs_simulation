...
def simulate_buoyancy_system(depth_command, dt=0.1, step_size=0.00005, kp=0.1, ki=0.01, kd=0.5, k_p=62.409, a_1=6.8, a_2=0.7, c=0.0, sensor_noise_std=0.0017, sensor_update_rate=10.0, use_sensor_model=True, ma_window_size=1):
