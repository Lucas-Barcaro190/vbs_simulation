...
def simulate_buoyancy_system(depth_command, dt=0.002, step_size=0.00005, kp=0.01, ki=0.001, kd=0.1, k_p=62.409, a_1=6.8, a_2=0.7, c=0.0, sensor_noise_std=0.0017, sensor_update_rate=10.0, use_sensor_model=True, ma_window_size=5):
    ...
    for i in range(n):
        ...
        acceleration = (k_p * actual_piston_pos - a_2 * velocity[i] - c * depth[i]) / a_1
